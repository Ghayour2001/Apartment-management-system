...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        $result = mysqli_query(
            $connection,
            "INSERT INTO add_floor(floor_no)VALUES('$floor_no')"
        );
        if ($result == true) {
...
<head>
    ...
    <title>Add floor Information </title>
                                    ...
                                    <div class="basic-form">
                                        <form id="fform" action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="floor_no" class="form-control" placeholder="Add Floor No">
                                            </div>
