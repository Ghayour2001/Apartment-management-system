...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query(
        $connection,
        "UPDATE maintenance SET maintenance_title='$maintenance_title', date='$date', amount='$amount', location='$location' WHERE id='$maintenance_id'"
    );
...
<head>
    ...
    <title>Update Maintenance Cost Information </title>
                                    ...
                                    <form id="mform" action="" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" class="form-control" value="<?php echo $rows[
                                                        'maintenance_title'
                                                    ]; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Date</label>
                                                    <input type="date" name="date" class="form-control" value="<?php echo $rows[
                                                        'date'
                                                    ]; ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Amount</label>
                                                    <input type="number" name="amount" class="form-control" value="<?php echo $rows[
                                                        'amount'
                                                    ]; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="location" class="form-control" value="<?php echo $rows[
                                                        'location'
                                                    ]; ?>">
                                                </div>
                                            </div>
