...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        $result = mysqli_query(
            $connection,
            "UPDATE add_designation SET emp_designation ='$designation' where designation_id='$designation_id'"
        );
        if ($result == true) {
                                    ...
                                    <div class="basic-form">
                                        <form id="dform" action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" class="form-control" value="<?php echo $rows[
                                                    'emp_designation'
                                                ]; ?>
                                                ">
                                            </div>
