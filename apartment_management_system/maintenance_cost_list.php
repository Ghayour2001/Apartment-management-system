...
<head>
    ...
    <title>Maintenance Cost List</title>
...
<?php include 'include/sidebar.php'; ?>
    ...
    <div class="content-wrap">
        <div class="main">
            ...
            <div class="row">
            <div class="col-md-12">
                        <a href="add_maintenance_cost.php" class="btn btn-info float-right">Add Maintenance Cost</a>
                        </div>
              <div class="col-lg-12">
                <div class="card">
                    ...
                    <table  id="bootstrap-data-table-export"
                      ...
                      <tbody class="text-center">
                        ...
                        while ($row = mysqli_fetch_array($result)) { ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $row['maintenance_title']; ?></td>
                            ...
                            <td>
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item"
                                  href="update_maintenance_cost.php?maintenance_id=<?php echo $row[
                                      'id'
                                  ]; ?>">Edit</a>
                                <a class="dropdown-item"
                                  href="delete.php?maintenance_id=<?php echo $row[
                                      'id'
                                  ]; ?>"
