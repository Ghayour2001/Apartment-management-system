...
<?php include 'include/sidebar.php'; ?>
    ...
    <div class="content-wrap">
        <div class="main">
            ...
            <div class="row">
            <div class="col-md-12">
                        <a href="add_designation.php" class="btn btn-primary float-right">Add Designation</a>
                        </div>
              <div class="col-lg-12">
                <div class="card">
                            ...
                            <td><button class="btn btn-sm dropdown-toggle more-horizontal"
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item"
                                                                    href="update_designation.php?designation_id=<?php echo $row[
                                                                        'designation_id'
                                                                    ]; ?>">Edit</a>
                                                                <a class="dropdown-item"
                                                                    href="delete.php?designation_id=<?php echo $row[
                                                                        'designation_id'
                                                                    ]; ?>"
